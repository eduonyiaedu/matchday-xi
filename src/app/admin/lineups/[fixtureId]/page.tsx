        ...
        <Card>
          ...
          <CardContent>
            <ManualLineupForm
              ...
              initialSelected={lineupFor(fixture.homeTeamId)?.players.map((p) => p.squadPlayerId).filter((id): id is string => !!id) ?? []}
            />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ManualLineupForm
              ...
              initialSelected={lineupFor(fixture.awayTeamId)?.players.map((p) => p.squadPlayerId).filter((id): id is string => !!id) ?? []}
            />
          </CardContent>
        </Card>
      </div>
