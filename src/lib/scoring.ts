 ...
 * +10 per predicted player found in the official starting XI, +25 bonus if all 11 match.
 */
...
const POINTS_PER_CORRECT_PLAYER = 10;
const PERFECT_XI_BONUS = 25;
...
export function scorePrediction(
  ...
  const pointsAwarded = correctSquadPlayerIds.length * POINTS_PER_CORRECT_PLAYER + (isPerfectXi ? PERFECT_XI_BONUS : 0);
